...
wp_enqueue_style('ballstreet-single', BALLSTREET_URI . '/css/single.css', ['ballstreet-base'], BALLSTREET_VERSION);
...
<article class="single-article">
    ...
    <header class="article-header fade-in">
        <span class="article-header-category"><?php echo esc_html($cat_name); ?></span>
        ...
        <div class="article-header-meta">
            <div class="article-author">
                <?php echo get_avatar(get_the_author_meta('ID'), 40, '', '', ['class' => 'article-author-avatar']); ?>
                <div>
                    <div class="article-author-name"><?php echo esc_html($author); ?></div>
                </div>
            </div>
        ...
        <section class="related-articles">
            ...
            <div class="articles-section">
                <?php while ($related->have_posts()) : $related->the_post(); ?>
                    ...
                    $rel_cat_name = !empty($rel_category) ? strtoupper($rel_category[0]->name) : 'NEWS';
                    $rel_read_time = ballstreet_get_read_time(get_the_content());
                    ?>
                    <article class="article-row fade-in">
                        <a href="<?php the_permalink(); ?>">
                            <span class="article-category"><?php echo esc_html($rel_cat_name); ?></span>
                            <h3 class="article-title"><?php the_title(); ?></h3>
                            <span class="article-time"><?php echo esc_html($rel_read_time); ?> min read</span>
                        </a>
                    </article>
                <?php endwhile; ?>
            </div>
